...
# ordered dict of mimeDict
orderedMimeDict = OrderedDict(sorted(mimeDict.items()))

# a frozenset of mimeDict's keys
...
if __name__ == '__main__':
    ...
    assert not is_valid_content_type('application/suck')
